...
class Bricka:
        ...
        for ev in pygame.event.get():
            if ev.type == pygame.KEYDOWN:
                ...
                if ev.key == pygame.K_LEFT:
                    self.paddle.left -= 30
                    print('set paddle left')
                    print(self.paddle.left)
                ...
                if ev.key == pygame.K_RIGHT:
                    ...
                    print('set paddle right')
                    print(self.paddle.right)
    ...
    def check_input_old(self):
        ...
        if keys[pygame.K_LEFT] or keys[pygame.K_l]:
            self.paddle.left -= PADDLE_WIDTH
            print('set paddle left')
            print(self.paddle.left)
            if self.paddle.left < 0:
                self.paddle.left = 0

        if keys[pygame.K_RIGHT] or keys[pygame.K_r]:
            self.paddle.left += PADDLE_WIDTH
